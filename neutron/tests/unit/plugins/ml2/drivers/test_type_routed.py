# Copyright (c) 2014,2015 Thales Services SAS
# All Rights Reserved.
#
...
from neutron.plugins.ml2.drivers import type_routed
from neutron.tests import base


class RoutedTypeTest(base.BaseTestCase):

    def setUp(self):
        super(RoutedTypeTest, self).setUp()
        self.driver = type_routed.RoutedTypeDriver()
        self.session = None

    def test_is_partial_segment(self):
        segment = {api.NETWORK_TYPE: p_const.TYPE_ROUTED}
